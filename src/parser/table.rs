    ...
    pub(super) fn new() -> Self {
        ...
        let productions = {
            vec![
                ...
                (Declaration, vec![Left(VariableDeclaration)]),
                ...
                (
                    ...
                    vec![
                        ...
                        Left(Expr),
                        Right(Semicolon(<_>::default())),
                        Left(Reduction(reduce_declaration)),
                    ],
                ),
                (
                    ProcDeclaration,
                ...
                (
                    Atom,
                    vec![Right(Identifier(<_>::default())), Left(AtomPrime)],
                ),
                (AtomPrime, vec![Left(Reduction(reduce_value))]),
                (
                    AtomPrime,
                    vec![
                        Right(LParen(<_>::default())),
